...
const Home = () => {
  ...
  return (
    <>
      <section
        className={`bg-img-general d-flex flex-column justify-content-center align-items-center text-center text-white fs-50px fw-900 ${Style.landing_page}`}
      >
        Welcome To Bookstore!
      </section>
      <section className={`d-flex text-white bg-black ${Device.isMobile ? "flex-column" : ""}`}>
        ...
        <div className={`d-flex flex-column px-5 pt-4 overflow-scroll ${Style.featured_content}`}>
